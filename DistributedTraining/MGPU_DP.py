...
'''
CUDA_VISIBLE_DEVICES=0,1,2,3 python MGPU_DP.py \
    --save-model \
    --save-path='./weights' \
...
def main():
    ...
    net = nn.DataParallel(net) # using DataParallel with minminal modification
    ...
    for ep in range(1, EPOCHS + 1):
        ...
        if args.save_model:
            ...
            model_state_save_path = os.path.join(args.save_path, "MGPU-DP-{}.pth".format(ep))
